...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *plusItem = [[UIBarButtonItem alloc] initWithTitle:@"+" style:UIBarButtonItemStylePlain target:self action:@selector(increaseFontSize)];
    UIBarButtonItem *minusItem = [[UIBarButtonItem alloc] initWithTitle:@"-" style:UIBarButtonItemStylePlain target:self action:@selector(decreaseFontSize)];
    
    self.navigationItem.rightBarButtonItems = @[plusItem, minusItem];
    
    UIBarButtonItem *dismissItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(pressButtonDismiss:)];
...
- (void) pressButtonDismiss:(UIBarButtonItem *)sender {
...
- (void)logToView:(NSString *)format, ... {
    ...
    [self logToViewString:logText];
    
    va_end(args_copy);
}

- (void)logToViewString:(NSString *)logText {
    // get the timestamp
